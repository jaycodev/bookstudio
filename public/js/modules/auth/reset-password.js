...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function validateConfirmPassword() {
    ...
    if (confirmPassword !== password) {
      ...
      document.getElementById('confirmNewPassword').nextElementSibling.innerHTML = ''
      return true
    }
  }
  ...
  document.getElementById('resetPasswordForm').addEventListener('submit', async function (e) {
    ...
    try {
      ...
      if (result.success) {
        document.querySelector('header.card-header h3').textContent = '¡Todo listo!'
        ...
        document.getElementById('confirmNewPassword').closest('.mb-4').remove()
        btn.remove()
        ...
        showToast(result.message || 'Ocurrió un error al restablecer la contraseña.', 'error')
      }
    } catch {
