...
function updateRow(author) {
  updateRowInTable({
    ...
    updateCellsFn: (row, a) => {
      ...
      cells[2].querySelector('span').textContent = a.nationalityName
      cells[3].querySelector('span').textContent = a.literaryGenreName
      cells[4].textContent = moment(a.birthDate).format('DD MMM YYYY')
